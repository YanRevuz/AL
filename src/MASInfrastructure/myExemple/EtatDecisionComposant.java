        ...
        if(c.getSharedData("decision") != null && c.getSharedData("decision").size() > 0 ){
            ...
            switch (lastInfo){
                case "Demande_Connexion":
                    ...
                    Message m = new Message(agt.getInfraAgentReference(), myComposant.getAgentServiceList().get(0).getInfraAgent().getInfraAgentReference(),"PropageDemande");
                ...
                case "ReponsePositiveComposant":
                    ...
                    Message m1 = new Message(agt.getInfraAgentReference(), myComposant.getAgentServiceList().get(0).getInfraAgent().getInfraAgentReference(),"ReponsePositiveComposant");
                    if (communication != null) {
            ...
            System.out.println("je n'ai pas de perception");
        }
